...
if [ "$ueditor" == "true" ]; then
    cp -rp $bak_dir/$webappname/$datetime/ueditor $deploy_dir/$webappname/ueditor
fi

#启动服务
service tomcat7 start

#~/deploy.sh -a https://ci.eulerproject.io/view/uwin-all/job/uwin-design-award/lastSuccessfulBuild/artifact/server/sz-design-award/target/ -w design-0.0.1-SNAPSHOT-debug.war -n tomcat7
